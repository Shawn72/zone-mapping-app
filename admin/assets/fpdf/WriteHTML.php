...
function tableHeader(){
	// $this->Image('./../assets/icons/logo.png',200,1,-500,"png");	
	// $this->Ln(40);
	$this->SetFont("Times", "B", 14);
	$this->Cell(276,5,"ZICCO TECHNOLOGIES",0,0,"C");
	$this->Ln();
	$this->SetFont("Times", "B", 14);
	$this->Cell(276,8,"Phone : 	+254 715 271 405",0,0,"C");
	$this->Ln();
	$this->Cell(276,8,"Email : 	harrisonkamote@gmail.com",0,0,"C");
	$this->Ln();
}
function headerTable()
{
  ...
  $this->Cell(200,10,'Product Name', 1, 0, 'L');
  $this->Cell(20,10,'Price', 1, 0, 'R');
  $this->Ln();
}
