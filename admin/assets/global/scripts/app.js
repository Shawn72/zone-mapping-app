var App = (function () {
    var t,
        ...
        P = function () {
            jQuery.fancybox && $(".fancybox-button").length > 0 && $(".fancybox-button").fancybox({ groupAttr: "data-rel", prevEffect: "none", nextEffect: "none", closeBtn: !0, helpers: { title: { type: "inside" } } });
        },
        T = function () {
        ...
        alert: function (t) {
            ...
            return (
                ...
                t.container
                    ...
                    : 1 === $(".page-fixed-main-content").length
                    ? $(".page-fixed-main-content").prepend(o)
                    : ($("body").hasClass("page-container-bg-solid") || $("body").hasClass("page-content-white")) && 0 === $(".page-head").length
                    ? $(".page-title").after(o)
                    : $(".page-bar").length > 0
                    ? $(".page-bar").after(o)
